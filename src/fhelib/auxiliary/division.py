...
def reciprocal_partial_sums_geometric(a:Ciphertext, n: int = 10, assumed_range: tuple = None) -> Ciphertext:
...
def reciprocal_newton_universal_guess(a: Ciphertext, n: int = 10, assumed_range: tuple = None, x0: float = None) -> Ciphertext:
    """
    ...
    if x0 is None and assumed_range is None:
        raise ValueError(
            "Either x0  or assumed_range required. "
        )
